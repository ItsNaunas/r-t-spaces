    ...
    <div className="bg-[var(--base)]">
      <main className="mx-auto w-full max-w-6xl space-y-12 px-4 pb-16 pt-12 sm:space-y-16 sm:px-6 lg:px-8">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-[var(--accent)]/20 p-6 space-y-4 rounded-lg">
              ...
              {/* Google Maps Embed */}
              <div className="relative w-full h-64 overflow-hidden border border-[var(--accent)]/10 rounded-lg">
                <iframe
              ...
              <a
                ...
                className="text-sm text-[var(--primary)] hover:text-[var(--accent-gold)] transition-colors inline-flex items-center gap-1"
              >
                Open in Google Maps
                ...
                >
                  ...
                  {detail.href ? (
                    <a
                      ...
                      className="text-lg text-[var(--primary)] hover:text-[var(--accent-gold)] transition-colors normal-case"
                    >
                      {detail.value}
                    </a>
                  ) : (
                    <p className="text-lg text-[var(--primary)] normal-case">
                      {detail.value}
                    </p>
                  )}
                </div>
            ...
            {/* Opening Hours */}
            <div className="border border-[var(--accent)]/20 p-6 bg-[var(--accent)]/5 rounded-lg">
              ...
              <div className="space-y-2">
                {openingHours.map((schedule, index) => (
                  <div key={index} className="flex justify-between items-center">
                    <span className="text-base text-[var(--primary)] font-semibold">
                      {schedule.day}
                    </span>
              ...
              <p className="text-sm text-[var(--muted-plum)] mt-4">
        ...
        <section className="border-t border-[var(--accent)]/20 pt-12">
          <h2 className="font-heading text-2xl text-[var(--primary)] mb-6 text-center">
            Quick Actions
          </h2>
