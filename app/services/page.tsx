...
function PackageCard({ pkg }: { pkg: BookingPackage }) {
  return (
    <article
      className={`relative flex flex-col rounded-2xl border-2 shadow-md transition-all duration-300 ${
        pkg.popular
    ...
    <div className="bg-[var(--base)]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-6 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                ...
                <BookNowButton className="rounded-full border border-white bg-transparent text-white hover:bg-white hover:text-[var(--primary)] transition-all duration-300 inline-flex items-center justify-center px-6 py-3.5 sm:px-8 sm:py-4 font-medium text-sm">
                  Book Now
                </BookNowButton>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {studioServices.map((service, index) => (
              <article
                key={service.title}
                className="rounded-2xl border border-[var(--accent)]/20 bg-white overflow-hidden hover:border-[var(--primary)] transition-all duration-300 group"
              >
                {service.image && (
                ...
                <div className="p-6 flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-[var(--primary)] text-white flex items-center justify-center font-heading text-lg">
      ...
      <main className="mx-auto w-full max-w-7xl space-y-16 px-4 pb-16 pt-12 sm:space-y-20 sm:px-6 lg:px-8">
        ...
        <section id="packages" className="scroll-mt-24">
          ...
          {/* Booking Terms */}
          <div className="mt-12 p-6 rounded-2xl bg-[var(--accent)]/5 border border-[var(--accent)]/20 border-l-4 border-l-[var(--primary)]">
        ...
        <section id="addons" className="scroll-mt-24">
          ...
          <div className="grid gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
            {ADDONS.map((addon) => (
              <div
                key={addon.id}
                className="rounded-2xl border-2 border-[var(--accent)]/20 shadow-md bg-white p-6 hover:border-[var(--primary)] hover:shadow-lg transition-all duration-300"
              >
                <div className="mb-4">
