...
const MEMBERSHIP_TIERS = [
  {
    ...
    period: "pcm",
    description:
      "A great fit for freelancers who want to grow their portfolio and attract more clients.",
    benefits: [
      "£120 per month, minimum three-month commitment",
      "8 hours of studio time included every month",
      "Use of all backdrops and extra equipment",
      "Weekday availability between 10 a.m. and 5 p.m.",
      "Top-up hours at £45/hr (standard rate £55/hr)",
    ],
    popular: false,
  ...
  },
  {
    ...
    period: "pcm",
    description:
      "Built for creatives who want to factor studio time into their rates and use the space regularly for test shoots and portfolio work.",
    benefits: [
      "£250 per month, minimum three-month commitment",
      "12 hours of studio hire included each month (weekdays and weekends)",
      "Priority booking so you can block your slots ahead of time",
      "Full use of backdrops and hireable equipment",
      "Extra hours at £40/hr (standard rate £55/hr)",
    ],
    popular: true,
