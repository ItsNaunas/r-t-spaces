...
import {
  ...
  STUDIO_POLICIES_SECTIONS,
} from "@/lib/studioPolicies";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Studio Policies — RT Spaces",
  description:
    "Studio policies and important information for RT Spaces. Bookings, payments, conduct, and terms.",
};
    ...
    <div className="bg-[var(--base)]">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          {STUDIO_POLICIES_SECTIONS.map((section, index) => (
            <section
              key={index}
