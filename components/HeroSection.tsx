...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[calc(100svh-73px)] items-center overflow-hidden bg-[var(--primary)] text-white">
      {/* Full-span studio image */}
      <Image
      ...
      {/* Plum brand tint (unifies the busy colours) */}
      <div className="absolute inset-0 bg-[var(--primary)]/50" />
      {/* Left-weighted gradient so the copy reads */}
      <div className="absolute inset-0 bg-gradient-to-r from-[var(--primary)] via-[var(--primary)]/75 to-transparent" />

      {/* Copy */}
      <div className="relative z-10 w-full">
        <div className="mx-auto w-full max-w-[1680px] px-6 py-16 sm:px-10 lg:px-16">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg text-base sm:text-lg text-white/90 leading-relaxed">
