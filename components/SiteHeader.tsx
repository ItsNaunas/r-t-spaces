      ...
      <div className={`mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8 relative transition-all duration-300`}>
        ...
        <div className="flex items-center gap-2 lg:gap-4 justify-end">
          <Link
            ...
            className={`flex items-center justify-center min-w-[44px] min-h-[44px] transition ${iconColor}`}
          >
          ...
          <button
            type="button"
            className={`min-w-[44px] min-h-[44px] inline-flex items-center justify-center md:hidden px-3 py-2 active:opacity-70 transition-opacity ${navTextColor}`}
